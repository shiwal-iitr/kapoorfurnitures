...
export const products = [
  {
    id: 9200 + 0,
    name: "Elegant Centre Table " + (0 + 1),
    slug: "elegant-centre-table-" + (0 + 1),
    category: 'centre-tables',
    price: 8000 + (0 * 500),
    originalPrice: 10000 + (0 * 500),
  ...
  {
    id: 9200 + 1,
    name: "Elegant Centre Table " + (1 + 1),
    slug: "elegant-centre-table-" + (1 + 1),
    category: 'centre-tables',
    price: 8000 + (1 * 500),
    originalPrice: 10000 + (1 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
  ...
  {
    id: 9200 + 2,
    name: "Elegant Centre Table " + (2 + 1),
    slug: "elegant-centre-table-" + (2 + 1),
    category: 'centre-tables',
    price: 8000 + (2 * 500),
    originalPrice: 10000 + (2 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
    image: "/images/centre_tables_raw/img_p2_1.png",
    isFeatured: false,
    isNew: true,
    rating: 4.6,
    reviews: 15
  ...
  {
    id: 9200 + 3,
    name: "Elegant Centre Table " + (3 + 1),
    slug: "elegant-centre-table-" + (3 + 1),
    category: 'centre-tables',
    price: 8000 + (3 * 500),
    originalPrice: 10000 + (3 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
    image: "/images/centre_tables_raw/img_p3_1.png",
    isFeatured: false,
    isNew: true,
    rating: 4.6,
    reviews: 15
  ...
  {
    id: 9200 + 4,
    name: "Elegant Centre Table " + (4 + 1),
    slug: "elegant-centre-table-" + (4 + 1),
    category: 'centre-tables',
    price: 8000 + (4 * 500),
    originalPrice: 10000 + (4 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
  ...
  {
    id: 9200 + 5,
    name: "Elegant Centre Table " + (5 + 1),
    slug: "elegant-centre-table-" + (5 + 1),
    category: 'centre-tables',
    price: 8000 + (5 * 500),
    originalPrice: 10000 + (5 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
  ...
  {
    id: 9200 + 6,
    name: "Elegant Centre Table " + (6 + 1),
    slug: "elegant-centre-table-" + (6 + 1),
    category: 'centre-tables',
    price: 8000 + (6 * 500),
    originalPrice: 10000 + (6 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
  ...
  {
    id: 9200 + 7,
    name: "Elegant Centre Table " + (7 + 1),
    slug: "elegant-centre-table-" + (7 + 1),
    category: 'centre-tables',
    price: 8000 + (7 * 500),
    originalPrice: 10000 + (7 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
  ...
  {
    id: 9200 + 8,
    name: "Elegant Centre Table " + (8 + 1),
    slug: "elegant-centre-table-" + (8 + 1),
    category: 'centre-tables',
    price: 8000 + (8 * 500),
    originalPrice: 10000 + (8 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
    image: "/images/centre_tables_raw/img_p8_1.png",
    isFeatured: false,
    isNew: true,
    rating: 4.6,
    reviews: 15
  ...
  {
    id: 9200 + 9,
    name: "Elegant Centre Table " + (9 + 1),
    slug: "elegant-centre-table-" + (9 + 1),
    category: 'centre-tables',
    price: 8000 + (9 * 500),
    originalPrice: 10000 + (9 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
  ...
  {
    id: 9200 + 10,
    name: "Elegant Centre Table " + (10 + 1),
    slug: "elegant-centre-table-" + (10 + 1),
    category: 'centre-tables',
    price: 8000 + (10 * 500),
    originalPrice: 10000 + (10 * 500),
    description: "A beautiful centre table to perfectly complement your living room seating. Features a sturdy design with a premium finish.",
    features: ["Sturdy Construction", "Premium Finish", "Modern Design"],
    dimensions: "Standard Centre Table Size",
    material: "Premium Wood / Glass",
  ...
  {
    id: 9000 + 0,
    name: "Classic Dining Table " + (0 + 1),
    slug: "classic-dining-table-" + (0 + 1),
    category: 'dining',
    price: 15000 + (0 * 1000),
    originalPrice: 18000 + (0 * 1000),
  ...
  {
    id: 9000 + 1,
    name: "Classic Dining Table " + (1 + 1),
    slug: "classic-dining-table-" + (1 + 1),
    category: 'dining',
    price: 15000 + (1 * 1000),
    originalPrice: 18000 + (1 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 2,
    name: "Classic Dining Table " + (2 + 1),
    slug: "classic-dining-table-" + (2 + 1),
    category: 'dining',
    price: 15000 + (2 * 1000),
    originalPrice: 18000 + (2 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 3,
    name: "Classic Dining Table " + (3 + 1),
    slug: "classic-dining-table-" + (3 + 1),
    category: 'dining',
    price: 15000 + (3 * 1000),
    originalPrice: 18000 + (3 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 4,
    name: "Classic Dining Table " + (4 + 1),
    slug: "classic-dining-table-" + (4 + 1),
    category: 'dining',
    price: 15000 + (4 * 1000),
    originalPrice: 18000 + (4 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 5,
    name: "Classic Dining Table " + (5 + 1),
    slug: "classic-dining-table-" + (5 + 1),
    category: 'dining',
    price: 15000 + (5 * 1000),
    originalPrice: 18000 + (5 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 6,
    name: "Classic Dining Table " + (6 + 1),
    slug: "classic-dining-table-" + (6 + 1),
    category: 'dining',
    price: 15000 + (6 * 1000),
    originalPrice: 18000 + (6 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 7,
    name: "Classic Dining Table " + (7 + 1),
    slug: "classic-dining-table-" + (7 + 1),
    category: 'dining',
    price: 15000 + (7 * 1000),
    originalPrice: 18000 + (7 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 8,
    name: "Classic Dining Table " + (8 + 1),
    slug: "classic-dining-table-" + (8 + 1),
    category: 'dining',
    price: 15000 + (8 * 1000),
    originalPrice: 18000 + (8 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9000 + 9,
    name: "Classic Dining Table " + (9 + 1),
    slug: "classic-dining-table-" + (9 + 1),
    category: 'dining',
    price: 15000 + (9 * 1000),
    originalPrice: 18000 + (9 * 1000),
    description: "A beautifully crafted dining table, perfect for your family meals. Designed with elegance and durability in mind.",
    features: ["Solid Wood Construction", "Spacious Tabletop", "Elegant Finish"],
    dimensions: "Standard Dining Size",
    material: "Premium Wood",
  ...
  {
    id: 9100 + 0,
    name: "Premium Dining Table Collection " + String.fromCharCode(65 + 0),
    slug: "premium-dining-table-" + String.fromCharCode(65 + 0).toLowerCase(),
    category: 'dining',
    price: 25000,
    originalPrice: 30000,
  ...
  {
    id: 9100 + 1,
    name: "Premium Dining Table Collection " + String.fromCharCode(65 + 1),
    slug: "premium-dining-table-" + String.fromCharCode(65 + 1).toLowerCase(),
    category: 'dining',
    price: 25000,
    originalPrice: 30000,
    description: "A premium multi-view dining table setting that elevates any dining space. See multiple angles to appreciate its fine craftsmanship.",
  ...
  {
    id: 9100 + 2,
    name: "Premium Dining Table Collection " + String.fromCharCode(65 + 2),
    slug: "premium-dining-table-" + String.fromCharCode(65 + 2).toLowerCase(),
    category: 'dining',
    price: 25000,
    originalPrice: 30000,
    description: "A premium multi-view dining table setting that elevates any dining space. See multiple angles to appreciate its fine craftsmanship.",
  ...
  // ========================
  {
    ...
    features: ['Hand-carved headboard', 'Solid teak wood construction', 'Anti-rust hardware', 'Built-in slat support'],
  ...
  },
  {
    ...
    features: ['Natural Sheesham wood', 'Honey finish', 'High weight capacity', 'Easy assembly'],
  ...
  },
  {
    ...
    features: ['Upholstered fabric headboard', 'Engineered wood frame', 'Noise-free construction', 'Modern minimalist design'],
  ...
  },
  {
    ...
    features: ['Four-poster canopy frame', 'Hand-carved detailing', 'Premium mango wood', 'Antique walnut finish'],
  ...
  },
  {
    ...
    features: ['Hydraulic lift storage', 'Two side drawers', 'Laminated finish', 'Heavy-duty gas lifts'],
  ...
  },
  {
    ...
    features: ['Kiln-dried neem wood', 'Compact design', 'Natural wood grain', 'Low-maintenance finish'],
  ...
  },
  {
    ...
    features: ['Powder-coated iron frame', 'Matte black finish', 'Anti-sway support legs', 'Minimal assembly required'],
  ...
  },
  {
    ...
    features: ['Low-profile platform design', 'Floating base illusion', 'Walnut laminate finish', 'No box spring needed'],
  ...
  },
  {
    ...
    features: ['Hand-carved floral motifs', 'Premium walnut wood', 'Heirloom quality', 'Natural lacquer finish'],
  ...
  },
  {
    ...
    features: ['Sustainably sourced mango wood', 'Natural grain patterns', 'Teak oil finish', 'Reinforced corner joints'],
  ...
  },
  {
    ...
    features: ['Pull-out trundle bed', 'Warm oak finish', 'Sturdy caster wheels', 'Dual-purpose design'],
  ...
  },
  {
    ...
    features: ['Indian rosewood construction', 'Mortise-and-tenon joints', 'Deep maroon polish', 'Colonial-era inspired design'],
  ...
  },
  {
    ...
    features: ['Full-length safety rails', 'Sturdy climbing ladder', 'Rubber wood construction', 'Can be split into two beds'],
  ...
  },
  {
    ...
    features: ['Day bed & night bed dual use', 'Three storage drawers', 'Backrest cushion included', 'Sheesham wood frame'],
  ...
  },
  {
    ...
    features: ['Woven rattan cane headboard', 'Teak wood frame', 'Tropical resort aesthetic', 'Breathable natural materials'],
  ...
  },
  {
    ...
    features: ['Premium leatherette upholstery', 'Diamond-tufted headboard', 'Padded frame edges', 'Stain-resistant surface'],
  ...
  },
  {
    ...
    features: ['Foldable space-saving design', 'Powder-coated metal frame', '120 kg weight capacity', 'Locking mechanism for safety'],
  ...
  },
  {
    ...
    features: ['Tall wingback headboard', 'Rich emerald velvet upholstery', 'Solid wood base', 'Channel tufting detail'],
  ...
  // ========================
  {
    ...
    features: ['3+2+1+1 configuration', 'Hand-carved Sheesham arms', 'High-resilience foam', 'Maroon premium fabric'],
  ...
  },
  {
    ...
    features: ['Modular rearrangeable sections', 'Seats up to 6', 'Stain-resistant grey fabric', 'Reversible chaise lounge'],
  ...
  },
  {
    ...
    features: ['Deep button tufting', 'Rolled arms design', 'Premium brown leatherette', 'Solid sal wood frame'],
  ...
  },
  {
    ...
    features: ['Space-saving compact design', 'Soft teal upholstery', 'Tapered wooden legs', 'Removable washable covers'],
  ...
  },
  {
    ...
    features: ['Manual recliner all seats', 'Adjustable footrests', 'Air leather upholstery', 'Steel recliner mechanism'],
  ...
  },
  {
    ...
    features: ['Solid mango wood frame', 'Lattice-pattern armrests', 'Rajasthani print cushions', '3+1+1 configuration'],
  ...
  },
  {
    ...
    features: ['Sofa to bed conversion', 'Built-in bedding storage', 'One-pull mechanism', 'High-density foam mattress'],
  ...
  },
  {
    ...
    features: ['Curved ergonomic silhouette', 'Velvet upholstery', 'Gold-finished metal legs', 'Matching bolster pillow'],
  ...
  },
  {
    ...
    features: ['Weather-resistant synthetic rattan', 'UV-protected weave', 'Quick-dry cushions', 'Powder-coated aluminium frame'],
  ...
  },
  {
    ...
    features: ['Natural oak wood legs', 'Pocket-spring cushions', 'Linen-blend fabric', 'Detachable armrests'],
  ...
  },
  {
    ...
    features: ['Sheesham wood frame', 'Hand-tied jute webbing', 'Cotton mattress included', 'Two matching bolsters'],
  ...
  },
  {
    ...
    features: ['Italian top-grain leather', 'Power-adjustable headrests', 'Memory foam cushions', 'Chrome-plated steel base'],
  ...
  },
  {
    ...
    features: ['Three adjustable positions', 'Sturdy metal frame', 'Thick padded seat', 'Faux linen upholstery'],
  ...
  },
  {
    ...
    features: ['Under-seat storage', 'Lift-up cushion mechanism', 'Solid teak wood frame', 'Removable cushion covers'],
  ...
  },
  {
    ...
    features: ['Child-safe rounded corners', 'Easy-clean leatherette', 'Lightweight frame', 'Fun candy colour options'],
  ...
  },
  {
    ...
    features: ['Six modular floor sections', 'High-density foam filling', 'Washable cotton covers', 'Bohemian embroidered design'],
  ...
  },
  {
    ...
    features: ['Professional geometric design', 'Black leatherette finish', 'Chrome-plated legs', 'High-density moulded foam'],
  ...
  },
  {
    ...
    features: ['Dramatic crescent shape', 'Plush ivory boucle fabric', 'Sculptural centrepiece design', 'Kiln-dried hardwood frame'],
  ...
  
  {
    ...
    features: ["Premium Material Construction", "Minimalistic & Elegant Design", "Durable & Long-lasting", "Easy to Maintain"],
